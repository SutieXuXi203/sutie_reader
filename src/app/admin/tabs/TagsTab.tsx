...
export const TagsTab = memo(
    ...
    (prev, next) => {
        ...
        return (
            ...
            prev.newTagName === next.newTagName &&
            prev.isCreatingTag === next.isCreatingTag &&
            prev.editingTag === next.editingTag &&
            prev.isUpdatingTag === next.isUpdatingTag &&
            prev.searchQuery === next.searchQuery &&
            prev.onNewTagNameChange === next.onNewTagNameChange &&
            prev.onCreateTag === next.onCreateTag &&
            prev.onEditingTagChange === next.onEditingTagChange &&
            prev.onUpdateTag === next.onUpdateTag &&
            prev.onDeleteTag === next.onDeleteTag
        );
    }
);
