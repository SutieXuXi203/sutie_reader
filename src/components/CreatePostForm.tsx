      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto rounded-none no-scrollbar">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <Input value={title} onChange={(e) => setTitle(e.target.value)} placeholder="Post title" maxLength={100} disabled={isSubmitting} className="rounded-none border-slate-200 dark:border-slate-700" />
          ...
          <div>
            ...
            <Textarea value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Brief description" maxLength={300} rows={2} disabled={isSubmitting} className="rounded-none border-slate-200 dark:border-slate-700" />
          ...
          <div>
            ...
            <Textarea value={content} onChange={(e) => setContent(e.target.value)} placeholder="Post content" rows={4} disabled={isSubmitting} className="rounded-none border-slate-200 dark:border-slate-700" />
          </div>

          <div>
            <label className="block text-sm font-medium text-slate-900 dark:text-white mb-2">Author name (optional)</label>
            <Input value={author} onChange={(e) => setAuthor(e.target.value)} placeholder="Your name" disabled={isSubmitting} className="rounded-none border-slate-200 dark:border-slate-700" />
          </div>
